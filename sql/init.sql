...
('brand_name',       '西域果铺',               '品牌名'),
('slogan',           '一口西域，一份实在',      '品牌口号'),
('wechat',           'xiyuguopu',             '微信号'),
('year',             '2025',                  '年份'),
('stats_regions',    '4',                     '覆盖产区数'),
('stats_orchards',   '30',                    '合作果园数'),
('stats_steps',      '6',                     '品控步骤'),
('stats_products',   '22',                    '产品SKU数'),
('stats_stars',      '6',                     '评分星数'),
('stats_price_adv',  '15',                    '价格优势%'),
('stats_satisfaction','100',                  '满意度%');
